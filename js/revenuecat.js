...
obj.Attention = "Xin chúc mừng vì đã thu thập được siêu dữ liệu! Được Duy Vinh chia sẻ, vui lòng không bán cho người khác!";
var duyvinh09 = {
      is_sandbox: !1,
      ...
      original_purchase_date: "2005-01-09T01:04:18Z",
  ...
  duyvinh = {
      ...
      expires_date: "2005-01-09T01:04:17Z"
  };
const match = Object.keys(mapping).find(e => ua.includes(e));
if (match) {
  let [e, s] = mapping[match];
  s ? (duyvinh.product_identifier = s, obj.subscriber.subscriptions[s] = duyvinh09) : obj.subscriber.subscriptions["com.duyvinh09.premium.yearly"] = duyvinh09, obj.subscriber.entitlements[e] = duyvinh
} else obj.subscriber.subscriptions["com.duyvinh09.premium.yearly"] = duyvinh09, obj.subscriber.entitlements.pro = duyvinh;
$done({
